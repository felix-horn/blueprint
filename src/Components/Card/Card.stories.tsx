...
export const Default: ComponentStory<typeof Card> = (args: CardProps) => {
  const [isSelected, setIsSelected] = useState<boolean | undefined>(Default.args?.isSelected);
...
export const DefaultCardHeadline = () => {
  return <Card.Headline>Example Headline</Card.Headline>;
};
...
export const CardWithLongHeadline = () => {
  ...
  return (
    ...
    >
      ...
      <StyledLineclampedText>This card does NOT have a CTA</StyledLineclampedText>
    </Card>
  );
};
...
export const CardWithoutCTA = () => {
  ...
  return (
    <Card headline="S line" rowGap="16px" onSelectCard={handleClick} isSelected={isSelected}>
      <Price formattedValue={examplePrice} />
...
export const CardWithoutHeadline = () => {
  ...
  return (
    <Card
      ...
      rowGap="16px"
    >
      <Text variant="copy2">This card has its headline somewhere else than on top.</Text>
      <Card.Headline>Headline</Card.Headline>
      <Price formattedValue={examplePrice} />
      <Text variant="copy2">
        This achieved by omitting the optional `headline` prop of the Card and using the dedicated
        `CardHeadline` as a child of the Card itself.
      </Text>
    </Card>
  );
};
...
export const TrimlineCard = () => {
  ...
  return (
    ...
    >
      <Price formattedValue={examplePrice} />
      <Text variant="copy2">
        Steigen Sie ein in die Individualisierung Ihres Fahrzeugs: Attraktive Ausstattungen,
        Alltagstauglichkeit, gepaart mit höchster Qualitätsanmutung stehen hier im Fokus...
      </Text>
    </Card>
  );
};
...
export const EngineCard = () => {
  ...
  return (
    ...
    >
      <Price formattedValue={examplePrice} />
      <Card.DataItem key={123} value="5.7 seconds (in boost mode) / 6.6 seconds">
...
export const Loading = () => {
  return (
    // eslint-disable-next-line no-console
    <Card headline="Some Headline" onSelectCard={() => console.log('selected')} isLoading>
